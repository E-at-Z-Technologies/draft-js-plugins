...
import Entry, { EntryComponentProps } from '@draft-js-plugins/mention/lib/MentionSuggestions/Entry/Entry';
import addMention from '@draft-js-plugins/mention/lib/modifiers/addMention';
import getSearchText from '@draft-js-plugins/mention/lib/utils/getSearchText';
import defaultEntryComponent from '@draft-js-plugins/mention/lib/MentionSuggestions/Entry/DefaultEntryComponent';
import { MentionData, MentionPluginStore, PopperOptions } from '@draft-js-plugins/mention/lib';
import defaultPositionSuggestions, {
    PositionSuggestionsFn,
} from '@draft-js-plugins/mention/lib/utils/positionSuggestions';
import { MentionPluginTheme } from '@draft-js-plugins/mention/lib/theme'
import getTriggerForMention from '@draft-js-plugins/mention/lib/utils/getTriggerForMention';
import Popover from '@draft-js-plugins/mention/lib/MentionSuggestions/Popover';
import { warning } from '@draft-js-plugins/mention/lib/utils/warning';
...
export interface MentionSuggestionsPubProps {
    ...
    onAddMention?(Mention: MentionData): Promise<MentionData | null>;
...
export class MentionSuggestions extends Component<MentionSuggestionsProps> {
    ...
    onMentionSelect = async (mention: MentionData | null): Promise<void> => {
        ...
        if (this.props.onAddMention) {
            mention = await this.props.onAddMention(mention);
            if (!mention) {
                return;
            }
        }
